...
<div class="seperator"></div><div class="padded seethru">
			<br><br>
	<h1>About KAHGY</h1>
	<p>KAHGY is RISEN (and as such, TSUKI)'s division specialised in taking care of old/outdated Systems. We're the ones in care of cleaning up, unlinking and destroying Life!</p>
	<p>Our team consists of the TSUKI Representative and the Ghendyts (who commonly goes by within RISEN as Key). It used to just be the Ghendyts running this lonely job of visiting Systems and restarting them, but for this mission more manpower was needed. As such, the TSUKI Representative was born!</p>
	<p>We hope you enjoy your stay in Life and LFE, and maybe we will meet again (hopefully not to destroy a System)!</p>
</div></body>
</html>
