...
<style>
	...
	<div class="panel" id="ghakuwentsji">
		<h1>Ghakuwent'sji</h1>
		<h2 class="syn">b}ncZWC</h2>
		<div class="desc">
			<p>Ghakuwent'sji is the largest city-state in LFE, divided into 372 substates.<br>
			It is composed of many interconnected islands - together forming one continent-sized city. There's always something to do in Ghakuwent'sji!</p>
		</div>
	</div>
	<center>Imagery does not represent actual location</center>
</body>
</html>
