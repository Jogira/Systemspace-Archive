...
<div class="seperator"></div><div class="padded seethru">
			<br><br>
	<h1>Copyright</h1>
	<p>This site is intended as a mirror to replicate the site "<a class='link' href="https://systemspace.link">systemspace.link</a>" for archiving purposes to allow access about the "TSUKI Project" for historical purposes and the Freedom of Information.</p>
	<p>This site may contain copyrighted material the use of which has not always been specifically authorized by the copyright owner. We are making such material available in an effort to advance understanding of the TSUKI Project, Systemspace and related materials. We believe this constitutes a ‘fair use’ of any such copyrighted material as provided for in section 107 of the US Copyright Law.</p>
	<p>In accordance with Title 17 U.S.C. Section 107, the material on this site is distributed without profit to those who have expressed a prior interest in receiving the included information for research and educational purposes. All content on this site belongs to it's respective owners.</p>
</div></body>
</html>
